...
export default function RegisterPage() {
  ...
  const s = {
    ...
    btn:      { width: "100%", backgroundColor: "var(--accent)", color: "#fff", borderRadius: 10, padding: "11px 0", fontSize: "0.88rem", fontWeight: 600, border: "none", cursor: "pointer", letterSpacing: "0.01em" },
    divider:  { display: "flex", alignItems: "center", gap: 12, margin: "4px 0" },
    line:     { flex: 1, height: 1, backgroundColor: "var(--border)" },
    divText:  { fontSize: "0.72rem", color: "var(--text-muted)", whiteSpace: "nowrap" as const },
